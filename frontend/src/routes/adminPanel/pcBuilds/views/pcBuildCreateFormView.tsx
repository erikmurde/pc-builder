...
const PcBuildCreateFormView = (props: {
    initialValues: IPcBuildCreateDTO,
    selectValues: {
        categories: ICategoryDTO[], 
        discounts: IDiscountDTO[], 
        components: IComponentSimpleDTO[]
    },
    validate: (values: IPcBuildCreateDTO) => IPcBuildCreateDTO,
    ...
    return (
        <div className="col content-panel content-scrollable">
            <FormHeader title="Create PC Build" nav="../pcbuilds" btn="Back"/>
            <Formik
                initialValues={props.initialValues}
                validate={(values) => props.validate(values)}
                onSubmit={(values) => props.onSubmit(values)}>
                <Form>
                    <TableHead title="General Info" btnName="Create"/>
...
export default PcBuildCreateFormView;